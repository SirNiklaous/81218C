...
void usercontrol(void) 
{
  while(true) 
  {
    //dont want sudden stops bc it will jerk = harder for driver to control
    ...
    right_front.setVelocity(Controller1.Axis3.position(percent), percent);
    right_back.setVelocity(Controller1.Axis3.position(percent), percent);
    left_front.setVelocity(Controller1.Axis2.position(percent), percent);
    left_back.setVelocity(Controller1.Axis2.position(percent), percent);
